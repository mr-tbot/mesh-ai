...
REQUIRES A WINDOWS PC WITH AN ESP BASED MESHTASTIC 2.5+ NODE WITH EITHER DIRECT USB CONNECTION OR WIFI SET UP WITH A STATIC IP - AS WELL AS THE FOLLOWING:
